...
public class RoomTypePhotoService {
	...
	public RoomTypePhotoVO addEmp(Integer roomTypePhotoId, Integer roomTypeId, byte[] roomTypePhoto,
			Boolean roomTypePhotoState) {
	...
	public RoomTypePhotoVO getOneRoomtypephoto(Integer roomTypePhotoId) {
